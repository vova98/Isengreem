...
enum commands_num { tmp, push = 1, pop = 2, add = 3, sub = 4, mul = 5, divi = 6, end = 7, 
...
int doCommand(cpu* This, const int* commandBuff, _TCHAR* argv)
{
	...
	while (commandBuff[i] != end)
	{
		...
		case ja:	Stack_ja(This, commandBuff[++i], &Step, &i, commandBuff); break;
		case jae:	Stack_jae(This, commandBuff[++i], &Step, &i, commandBuff); break;
		case jb:	Stack_jb(This, commandBuff[++i], &Step, &i, commandBuff); break;
		case jbe:	Stack_jbe(This, commandBuff[++i], &Step, &i, commandBuff); break;
		case je:	Stack_je(This, commandBuff[++i], &Step, &i, commandBuff); break;
		case jne:	Stack_jne(This, commandBuff[++i], &Step, &i, commandBuff); break;
