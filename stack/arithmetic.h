...
enum commands_num { tmp, push = 1, pop = 2, pop_ax = 18, add = 3, sub = 4, mul = 5, divi = 6, end = 7, 
	out = 8, sqr = 9, push_ax = 10, ja = 11, jae = 12, jb = 13, jbe = 14, je = 15, jne = 16, jmp = 17, call = 19, ret = 20, pop_bx = 21, pop_cx = 22, pop_dx = 23, push_bx = 24, push_cx = 25, push_dx = 26 , root = 27, err = 28};
